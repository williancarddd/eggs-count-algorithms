...
eggs - v1 2025-03-08 4:58pm
==============================

This dataset was exported via roboflow.com on March 8, 2025 at 9:00 PM GMT
...
Eggs are annotated in YOLOv11 format.

The following pre-processing was applied to each image:
* Auto-orientation of pixel data (with EXIF-orientation stripping)
* Resize to 254x254 (Stretch)
